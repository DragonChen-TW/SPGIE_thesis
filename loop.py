...
#     '--dataset_name mnist --hidden_dim 128 --max_epoch 100 --device cuda:1',
#     '--dataset_name mnist --hidden_dim 256 --max_epoch 100 --device cuda:1',
...
# #     ==================== mnist_m ====================
#     '--dataset_name mnist_m --hidden_dim 20 --max_epoch 100 --num_sp 75 --device cuda:1',
#     '--dataset_name mnist_m --hidden_dim 64 --max_epoch 100 --num_sp 75 --device cuda:1',
#     '--dataset_name mnist_m --hidden_dim 128 --max_epoch 100 --num_sp 75 --device cuda:0',
